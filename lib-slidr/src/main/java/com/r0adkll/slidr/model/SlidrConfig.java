...
public class SlidrConfig {
  ...
  private boolean edge;//用于标识是否仅在左侧边缘生效
  private float edgeSize;// 边缘生效位置(屏幕宽度的百分比)
  ...
  public static class Builder {
    ...
    public Builder edgeSize(@FloatRange(from = 0.1f, to = 1.0f) float size) {
      config.edgeSize = size;
      return this;
    }
